...
**Live gate status: [STATUS.md](STATUS.md)** — generated by `verify_10.py --status-md`, never hand-
written. Prose in this file describes what each leg *means* and what is owner-gated; it deliberately
