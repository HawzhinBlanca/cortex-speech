#!/usr/bin/env python3
"""Atomically arm the strict two-person paid-review certification pilot.
...
pairing, cookie, and outstanding hidden-check state to the two pilot reviewers without decrypting or changing
...
# One roster for the whole pilot toolchain; see review_pilot_hidden_contract for where it comes from.
REVIEWERS = PILOT_REVIEWERS
CAP_PER_REVIEWER = 10
TOTAL_CAP = 20
    ...
    *,
    ...
    try:
        ...
        if replace_roster_before_activity:
            ...
            # retained, but every mutable/leased cache is reset so both reviewers claim a clean batch.
            narrowed["sessions"] = []
