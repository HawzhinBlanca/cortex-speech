...
def seed(root: Path) -> tuple[Path, Path, dict[str, object]]:
    ...
    conn.executescript(
        ...
        INSERT INTO review_events VALUES(875, 'legacy', 'Sara', 'edit', 'couch');
    ...
    session: dict[str, object] = {
        ...
        "spot_checks": [],
        "pilot_spot_checks": [],
        "sessions": [{"token": "cookie-r", "reviewer": "Sara", "issued_unix": 1}],
        "pilot_policy": None,
    }
...
def test_success_is_exact_history_preserving_and_session_byte_preserving() -> None:
    with tempfile.TemporaryDirectory() as raw:
        ...
        assert events == [(875, "legacy", "Sara", "edit", "couch")]
