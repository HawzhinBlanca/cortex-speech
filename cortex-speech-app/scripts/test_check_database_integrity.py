...
class DatabaseIntegrityGateTests(unittest.TestCase):
    ...
    def test_clean_database_passes_all_three_checks(self):
        ...
        self.assertEqual(report["schemaVersion"], 62)
        self.assertEqual(report["migrationHistoryEntries"], 62)
    ...
    def test_clean_but_stale_schema_is_red(self):
        ...
        self.assertEqual(report["requiredSchemaVersion"], 62)
        self.assertTrue(any("missing=[60, 61, 62]" in error for error in report["errors"]), report)
    ...
    def test_missing_middle_history_or_wrong_description_is_red(self):
        ...
        code, report = self.run_gate()
        self.assertEqual(code, 1, report)
        self.assertEqual(report["schemaVersion"], 62, "MAX alone would falsely green this fixture")
