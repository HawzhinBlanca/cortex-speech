...
LOCKED_VERSIONS = [66, 67, 68, 69, 70, 71, 72, 73]
...
def test_append_only_migrations_66_through_73_match_individual_source_hashes() -> None:
...
def main() -> None:
    test_append_only_migrations_66_through_73_match_individual_source_hashes()
    ...
    print(f"append-only migration source blocks 66-73 are immutable: {hashes}")
