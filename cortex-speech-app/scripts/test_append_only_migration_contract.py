...
LOCKED_VERSIONS = [66, 67, 68, 69, 70, 71, 72]
...
def test_append_only_migrations_66_through_72_match_individual_source_hashes() -> None:
...
def main() -> None:
    test_append_only_migrations_66_through_72_match_individual_source_hashes()
    ...
    print(f"append-only migration source blocks 66-72 are immutable: {hashes}")
