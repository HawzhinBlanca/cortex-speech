export const ckb: Record<string, string> = {
  ...
  'validation.tab.ood': 'ناهەنجاری سیگناڵ',
  ...
  'validation.ood.title': 'پشکنینی ناهەنجاری سیگناڵ (هیوریستیک)',
  ...
  'validation.ood.run': 'ئەنجامدانی پشکنینی ناهەنجاری سیگناڵ',
  'validation.ood.running': 'پشکنین بۆ ناهەنجاری سیگناڵ...',
  'validation.ood.success': 'نمرەی ناهەنجاری سیگناڵ بۆ {n} بەش حیساب کرا.',
  'validation.ood.score': 'نمرەی ناهەنجاری',
  'validation.ood.isOod': 'سیگناڵی ناهەنجار',
  'validation.ood.noOod': 'هیچ بەشێک وەک ناهەنجار دیاری نەکرا.',
  'validation.ood.showAll': 'پیشاندانی هەموو بەشەکان (نەک تەنها ناهەنجارەکان)',
