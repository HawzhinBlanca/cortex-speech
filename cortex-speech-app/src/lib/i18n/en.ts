export const en: Record<string, string> = {
  ...
  'validation.tab.ood': 'Signal Anomaly',
  ...
  'validation.ood.title': 'Signal-Anomaly Screen (heuristic)',
  ...
  'validation.ood.run': 'Run Signal-Anomaly Screen',
  'validation.ood.running': 'Screening for signal anomalies...',
  'validation.ood.success': 'Computed signal-anomaly scores for {n} segments.',
  'validation.ood.score': 'Anomaly Score',
  'validation.ood.isOod': 'Anomalous signal',
  'validation.ood.noOod': 'No segments flagged as anomalous.',
  'validation.ood.showAll': 'Show all segments (not just anomalous ones)',
