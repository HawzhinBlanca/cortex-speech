export const en: Record<string, string> = {
  ...
  'stats.relink': 'Relink…',
  'reason.low_snr': 'Noisy audio (low signal-to-noise)',
  'reason.clipping': 'Clipped audio (recorded too loud)',
  'reason.single_recognizer': 'Only one recogniser spoke',
  'reason.model_disagreement': 'Recognisers disagreed',
  'reason.uncalibrated_bucket': 'No calibration for this audio quality yet',
  'reason.policy_hold': 'Held for you by the autonomy setting',
  'reason.missing_audio': 'Audio could not be read',
  'reason.t2_no_majority': 'Listener panel reached no majority',
  'reason.t1_unresolved': 'Unresolved, cloud check is off',
  'reason.whyEscalated': 'Why this needs you',
