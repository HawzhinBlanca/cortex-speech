...
pub struct WordTimestamp {
    ...
    pub start: f64,
    pub end: f64,
    // Round-25 #1: default to 0.0 when absent. Without this, a caller-supplied alignment_json whose
    // words omit `confidence` failed to deserialize, word_timestamps_from_alignment returned None, and
